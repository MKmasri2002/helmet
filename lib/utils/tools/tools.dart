...
import 'package:helmet_customer/utils/tools/android_loading.dart';
import 'package:helmet_customer/utils/tools/ios_loading.dart';
...
class AppTools {
  ...
  String washType(int type) {
    if (type == 0) {
      return 'inside wash'.tr;
    } else if (type == 1) {
      return 'inside out wash'.tr;
    } else if (type == 2) {
      return 'package'.tr;
    } else if (type == 3) {
      return 'oneTimeWash'.tr;
    } else if (type == 4) {
