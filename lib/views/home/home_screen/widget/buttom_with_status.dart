                  ...
                  child: Row(
                    children: [
                      ...
                      HorizontalDashedLine(
                        color: nearestOrder!.status != 'on_way'
                            ? Colors.white
                            : Colors.grey,
                        isLine: nearestOrder!.status != 'on_way' ? true : false,
                      ),
                      ...
                      HorizontalDashedLine(
                        color: nearestOrder!.status != 'on_way' &&
                                nearestOrder!.status != 'arrived'
                            ? Colors.white
                            : Colors.grey,
                        isLine: nearestOrder!.status != 'on_way' &&
                                nearestOrder!.status != 'arrived'
                            ? true
                            : false,
                      ),
